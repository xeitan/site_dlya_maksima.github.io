...
function initCalculator() {
    ...
    function calculate() {
        ...
        // 3. Update output UI
        resCurrentLeads.textContent = totalBaseLeads.toLocaleString('ru-RU');
        resTrafficM1.textContent = trafficM1.toLocaleString('ru-RU');
        resLeadsM1.textContent = leadsM1.toLocaleString('ru-RU');
        resTrafficM2.textContent = trafficM2.toLocaleString('ru-RU');
        resLeadsM2.textContent = leadsM2.toLocaleString('ru-RU');
...
function initSlider() {
    ...
    function getVisibleSlidesCount() {
        ...
        return 2; // Mobile / Tablet (as requested: mobile 2)
    }
